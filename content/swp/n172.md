...
slug: n172
category: swp
tags: preston_john, parris_samuel, esty_isaac_sr, wardwell_samuel, esty_isaac_jr, gill_sarah, barker_abigail, nurse_john, nurse_rebecca, nurse_samuel_jr, tarbell_john, nurse_samuel_sr, parker_joseph, ballard_joseph, preston_rebecca, how_abigail, esty_joseph, parker_john, esty_mary, dane_nathaniel, proctor_john, cloyce_peter, wise_john, gerrish_joseph, wardwell_sarah, osgood_mary, how_elizabeth, symmes_zechariah, faulkner_abigail_jr, rogers_john, dane_deliverence, cheever_ezekiel, how_mary, faulkner_francis, dane_francis_sr, tyler_hannah, rich_thomas, fitch_jabez, faulkner_abigail_sr, green_joseph, stoughton_william, wilson_sarah_sr, tyler_martha, nurse_benjamin, jacobs_george_sr, nurse_samuel, english_phillip, hubbard_william, proctor_thorndike, capen_joseph, corey_martha, townsend_penn, phillips_timothy, rolfe_benjamin, parker_mary, symmes_thomas, barnard_thomas, johnson_john, proctor_elizabeth, converse_james, corey_giles, proctor_benjamin, phipps_william, robinson_phoebe, addington_isaac
...
[Samuel Nurse](/tag/nurse_samuel.html)
